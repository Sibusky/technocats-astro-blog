...
import { s as slugify, f as formatDate, $ as $$Link, a as formatBlogPosts, b as $$MainLayout } from './404.astro.bbf30d01.mjs';
...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.30cc23b9.mjs').then(n => n.s).catch(() => {
      throw new Error(
  ...
  const isDev = (_b = (Object.assign({"BASE_URL":"/","MODE":"production","DEV":false,"PROD":true,"SSR":true,"SITE":"https://astro-tehnocats.netlify.app/","ASSETS_PREFIX":undefined},{SSR:true,}))) == null ? void 0 : _b.DEV;
...
}, "D:/webWork/intern/projects/birka/node_modules/@astrojs/image/components/Image.astro");
...
}, "D:/webWork/intern/projects/birka/node_modules/@astrojs/image/components/Picture.astro");
...
}, "D:/webWork/intern/projects/birka/src/components/PostCard.astro");
...
` })}`;
}, "D:/webWork/intern/projects/birka/src/pages/author/[...author].astro");

const $$file = "D:/webWork/intern/projects/birka/src/pages/author/[...author].astro";
