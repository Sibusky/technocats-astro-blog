...
import { a as $$Image } from './_...author_.astro.4c759066.mjs';
import { s as slugify, f as formatDate, a as formatBlogPosts, b as $$MainLayout } from './404.astro.bbf30d01.mjs';
import { $ as $$CategoryCloud } from './_...page_.astro.fe58f165.mjs';
import React, { useCallback, useState, useEffect } from 'react';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { getFirestore, doc, collection, getDocs, getDoc, setDoc, addDoc, updateDoc } from 'firebase/firestore';
...
}, "D:/webWork/intern/projects/birka/src/components/PostHeader.astro");
...
}, "D:/webWork/intern/projects/birka/src/components/RelatedPosts.astro");
...
__astro_tag_component__(useFormWithValidation, "@astrojs/react");
...
const CommentOnTheWall = ({
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      className: "info-about-comment",
      children: [/* @__PURE__ */ jsx(PersonIcon, {}), /* @__PURE__ */ jsx("h3", {
...
__astro_tag_component__(CommentOnTheWall, "@astrojs/react");
...
function Comment({
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [fullComments.map((com) => /* @__PURE__ */ jsx(CommentOnTheWall, {
      id: com.id,
      comment: com.data,
      postId: id,
...
__astro_tag_component__(Comment, "@astrojs/react");
...
<h2 class="h3">Comments</h2>
  <section class="comments" style="display: flex; flex-direction: column; gap: 5px; ">
    ${renderComponent($$result, "Comment", Comment, { "id": id, "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/webWork/intern/projects/birka/src/components/Comment", "client:component-export": "default" })}
  </section>
</section>`;
}, "D:/webWork/intern/projects/birka/src/components/Comments.astro");
...
const $$BlogPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead($$result2)}<div class="post-content">
    ...
    ${renderComponent($$result2, "Buttons", Buttons, { "id": id, "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/webWork/intern/projects/birka/src/components/Buttons", "client:component-export": "default" })}
    ${renderComponent($$result2, "Comments", $$Comments, { "id": id })}
  </div>
` })}`;
}, "D:/webWork/intern/projects/birka/src/layouts/BlogPostLayout.astro");
...
const images = {
				...
				const file = "D:/webWork/intern/projects/birka/src/pages/blog/aleksei-smirnov.md";
