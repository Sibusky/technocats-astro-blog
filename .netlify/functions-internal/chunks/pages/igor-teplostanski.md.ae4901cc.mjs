...
const images = {
				...
				const frontmatter = {"id":6,"layout":"../../layouts/BlogPostLayout.astro","title":"Igor Teplostanski. My way to IT.","date":"2023-05-20T00:00:00.000Z","author":"Igor Teplostanski","image":{"src":"/images/igor-teplostanski.jpg","alt":"Igor Teplostanski's photo"},"description":"1 + 1 = 11","draft":false,"category":"Changing the career"};
				const file = "/Users/Sibusky/dev/birka/src/pages/blog/igor-teplostanski.md";
