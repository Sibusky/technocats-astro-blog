...
async function getImage(transform) {
  ...
  const isDev = (_b = (Object.assign({"BASE_URL":"/","MODE":"production","DEV":false,"PROD":true,"SSR":true,"SITE":"https://astro-tehnocats.netlify.app/","ASSETS_PREFIX":undefined},{_:process.env._,SSR:true,}))) == null ? void 0 : _b.DEV;
...
}, "/Users/Sibusky/dev/birka/node_modules/@astrojs/image/components/Image.astro");
...
}, "/Users/Sibusky/dev/birka/node_modules/@astrojs/image/components/Picture.astro");
...
const $$PostCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<article class="card">
    ...
    <a${addAttribute(url, "href")} aria-hidden="true" tabindex="-1">
        ${renderComponent($$result, "Image", $$Image, { "src": image.src, "alt": image.alt, "width": "400", "height": "250", "format": "avif", "fit": "cover", "quality": 80, "aspectRatio": "4:1" })}
    </a>
    <div class="content">
        <div>
            ${renderComponent($$result, "Tag", Tag, { "class": "h3" }, { "default": ($$result2) => renderTemplate`
                <a${addAttribute(url, "href")}>${title}</a>
            ` })}
            <small>
                by
                <a${addAttribute(`/author/${slugify(author)}/`, "href")}>${author}
                </a> - ${formatDate(date)}
            </small>
        </div>
        <p>${description}</p>
        ${renderComponent($$result, "Link", $$Link, { "href": url, "text": "Read post", "style": "secondary" })}
    </div>   
</article>`;
}, "/Users/Sibusky/dev/birka/src/components/PostCard.astro");
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": authorName }, { "default": ($$result2) => renderTemplate`
  ${maybeRenderHead($$result2)}<section class="container"${addAttribute(`Posts by ${authorName}`, "aria-label")}>
      <h1 class="h1">Posts by <span>${authorName}</span></h1>
      <div class="post-container">
        ${posts.map((post) => renderTemplate`${renderComponent($$result2, "PostCard", $$PostCard, { "frontmatter": post.frontmatter, "url": post.url, "tagType": "h2" })}`)}
      </div>
  </section>
` })}`;
}, "/Users/Sibusky/dev/birka/src/pages/author/[...author].astro");

const $$file = "/Users/Sibusky/dev/birka/src/pages/author/[...author].astro";
...
export { $$PostCard as $, BaseSSRService as B, ____author_ as _, $$Image as a, isRemoteImage as b, isOutputFormatSupportsAlpha as i };
